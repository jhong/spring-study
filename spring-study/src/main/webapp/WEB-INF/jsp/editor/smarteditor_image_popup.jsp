...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
		...
		<input type="hidden" name="command" value="registSmart"/>
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="#"><img src="<c:url value='common/js/smarteditor/img/photoQuickPopup/btn_confirm.png'/>" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="#"><img src="<c:url value='common/js/smarteditor/img/photoQuickPopup/btn_cancel.png'/>" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
<script type="text/javascript" src="<c:url value='common/js/smarteditor/photo_uploader/popup/jindo.min.js'/>" charset="utf-8"></script>
<script type="text/javascript" src="<c:url value='common/js/smarteditor/photo_uploader/popup/jindo.fileuploader.js'/>" charset="utf-8"></script>
<script type="text/javascript" src="<c:url value='common/js/smarteditor/photo_uploader/popup/attach_photo.js'/>" charset="utf-8"></script>

<script type="text/javascript">
function addUploadedImage_success() {
	alert("popup... addUploadedImage()");
}
