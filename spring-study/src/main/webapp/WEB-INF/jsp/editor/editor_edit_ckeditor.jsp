...
<script src="<c:url value='common/js/ckeditor/ckeditor.js'/>" type="text/javascript" charset="utf-8"></script>
...
CKEDITOR.replace( 'contents', {
	language: 'ko'
	, filebrowserImageUploadUrl: "<c:url value='attach.do?command=registCk'/>"
});
