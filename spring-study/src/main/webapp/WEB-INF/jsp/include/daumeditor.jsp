...
<link rel="stylesheet" href="<c:url value='common/js/daumeditor/css/editor.css'/>" type="text/css" charset="utf-8"/>
<script src="<c:url value='common/js/daumeditor/js/editor_loader.js?environment=development'/>" type="text/javascript" charset="utf-8"></script>
...
<div class="body">
	...
	-->
	<form name="tx_editor_form" id="tx_editor_form" action="" method="post" onsubmit="return false;" accept-charset="utf-8">
		<!-- 에디터 컨테이너 시작 -->
